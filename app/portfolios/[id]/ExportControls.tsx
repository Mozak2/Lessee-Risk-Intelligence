      ...
      <div className="px-4 py-5 sm:p-6">
        ...
        {hasSimulation && (
          <div className="mb-4 p-3 bg-purple-50 dark:bg-purple-900/20 border border-purple-200 dark:border-purple-800 rounded-md">
            <label className="flex items-center cursor-pointer">
              ...
              />
              <span className="ml-2 text-sm text-purple-900 dark:text-purple-100">
        ...
        <div className="flex flex-col sm:flex-row gap-3">
          <button
            ...
            className="flex-1 inline-flex justify-center items-center px-4 py-2 border border-gray-300 dark:border-gray-600 shadow-sm text-sm font-medium rounded-md text-gray-700 dark:text-gray-300 bg-white dark:bg-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 disabled:opacity-50 disabled:cursor-not-allowed"
          >
