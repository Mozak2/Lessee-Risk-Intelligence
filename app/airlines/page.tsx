  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="mt-8">
        ...
        <div className="mt-8">
          <h3 className="text-lg font-medium text-gray-900 mb-4">Popular Airlines</h3>
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {popularAirlines.map((airline) => (
              <Link
                key={airline.icao}
                href={`/airlines/${airline.icao}`}
                className="relative rounded-lg border border-gray-300 bg-white px-6 py-5 shadow-sm hover:border-gray-400 focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-blue-500"
              >
                <div>
                  <h3 className="text-sm font-medium text-gray-900">{airline.name}</h3>
                  <p className="mt-1 text-sm text-gray-500">{airline.icao}</p>
                </div>
              </Link>
            ))}
          </div>
